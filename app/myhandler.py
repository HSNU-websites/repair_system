...
def timeformat_to_regex(timeformat: str):
    ...
    timeformat = timeformat.replace(r"%d", r"\d{2}")
...
class MyTimedRotatingFileHandler(BaseRotatingHandler):
    ...
    def computeRollover(self, currentTime):  # Not modified
        """
    ...
    def shouldRollover(self, record):  # Not modified
        """
    ...
    def getFilesToDelete(self):
        ...
        """
        rotatedirName, rotatebaseName = os.path.split(self.rotatefilename)
        fileNames = os.listdir(rotatedirName)
        result = []
        for fileName in fileNames:
            if self.rotatedmatch.match(fileName):
                result.append(os.path.join(rotatedirName, fileName))
    ...
    def doRollover(self):
        ...
        dfn = self.rotation_filename(time.strftime(self.rotatefilename, timeTuple))
