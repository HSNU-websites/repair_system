...
from .db_helper import render_buildings
from .db_helper import render_items
...
class ReportForm(FlaskForm):
    building = SelectField("大樓: ",
                           choices=render_buildings(),
                           validators=[DataRequired()])
    place = StringField("地點: ", validators=[DataRequired()])
    item = SelectField("損壞物件: ",
                       choices=render_items(),
                       validators=[DataRequired()])
